...
FLAG='quiet loglevel=3 rd.systemd.show_status=auto nowatchdog nomce rd.udev.log_level=3 mitigations=off random.trust_cpu=on nvidia-drm.modeset=1 fsck.mode=skip libahci.ignore_sss=1 i915.modeset=1'
